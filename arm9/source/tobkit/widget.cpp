...
Widget::Widget(u8 _x, u8 _y, u8 _width, u8 _height, u16 **_vram, bool _visible)
	:x(_x), y(_y), width(_width), height(_height), visible(_visible),
	   enabled(true),vram(_vram)
{
...
inline const u16 Widget::interpolateColor(u16 col1, u16 col2, u8 alpha) {
	/*
